                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post" action="/user">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="inputSuccess" type="text" name="name">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="inputWarning">Email</label>
                            <input class="form-control" id="inputWarning" type="email" name="email">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="inputError">Hp</label>
                            <input class="form-control" id="inputError" type="text" name="hp">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="inputError">Jabatan</label>
                            <input class="form-control" id="inputError" type="text" name="jabatan">
                        </div>
                        <div class="form-group">
